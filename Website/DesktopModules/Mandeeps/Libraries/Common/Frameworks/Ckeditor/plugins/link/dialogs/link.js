        ...
        return {
            ...
            },
            {
                ...
                elements: [{
                    type: 'checkbox',
                    id: 'abtesting',
                    label: 'Track this link as conversion',
                    style: 'height:40px',
                    size: 29,
                    setup: function (data) {
                        if (data.abtesting !== undefined)
                            this.setValue('checked', 'checked');
                    },
                    commit: function (data) {
                        if (this.getValue()) {
                            data.abtesting = this.getValue();
                        }
                    }
                }]
            }],
            onShow: function () {
                ...
                var tracking = $($('.' + editor.id).prev()).attr('abtesting');
                if (tracking != undefined && tracking != null && JSON.parse(tracking))
                    this.showPage('abtesting');
