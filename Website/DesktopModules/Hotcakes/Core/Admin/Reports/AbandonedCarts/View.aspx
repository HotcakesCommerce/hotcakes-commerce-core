<%@ Page Language="C#" MasterPageFile="../../AdminNav.master" AutoEventWireup="true" CodeBehind="View.aspx.cs" Inherits="Hotcakes.Modules.Core.Admin.Reports.AbandonedCarts.View" %>
...
<asp:Content ContentPlaceHolderID="MainContent" runat="Server">
    <div class="hcReport">
        ...
        <div class="hcForm">
            <div class="hcFormItem">
                <asp:Label ID="lblNoCartsMessage" resourcekey="NoAbandonedCartsFound" CssClass="hcInfoLabelLeft" Visible="false" runat="server" />
            </div>
        </div>
