<%@ Control Language="C#" AutoEventWireup="True" Inherits="Hotcakes.Modules.Core.Admin.Parts.CreditCardGateways.Authorize.Net.Edit" CodeBehind="Edit.ascx.cs" %>
<h1>
    <asp:Label runat="server" resourcekey="AuthorizeNetOptions" />
</h1>
<div class="hcForm">
