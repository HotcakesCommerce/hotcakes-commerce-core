<%@ Control Language="C#" AutoEventWireup="True" Inherits="Hotcakes.Modules.Core.Modules.Shipping.Rate_Table_by_Total_Weight.Edit" CodeBehind="Edit.ascx.cs" %>
...
<div class="dnnForm">
    ...
    <div class="hcFormItemHor">
        ...
        <asp:CustomValidator ID="cvAdjustmentTextBox" runat="server" ControlToValidate="AdjustmentTextBox" CssClass="hcFormError"
...
<div class="hcBlock">
    ...
    <div class="hcForm">
        <div class="hcFormItemHor">
            ...
            <asp:TextBox ID="NewLevelField" runat="server" ValidationGroup="RateTable"  MaxLength="7"/>
        ...
        <div class="hcFormItemHor">
            ...
            <asp:TextBox ID="NewAmountField" runat="server" ValidationGroup="RateTable"  MaxLength="7"/>
        ...
        <div class="hcFormItemHor">
            <asp:LinkButton ID="btnNew" resourcekey="btnNew" runat="server" CssClass="hcSecondaryAction" OnClick="btnNew_Click" ValidationGroup="RateTable" />
        </div>
    </div>
</div>