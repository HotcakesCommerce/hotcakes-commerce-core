<%@ Page Language="C#" MasterPageFile="../AdminNav.master" AutoEventWireup="True" Inherits="Hotcakes.Modules.Core.Admin.People.Vendors_Edit" Title="Untitled Page" CodeBehind="Vendors_Edit.aspx.cs" %>
	...
	<div class="hcBlock">
        <div class="hcForm">
            <div class="hcFormItem">
                <asp:HyperLink ID="hypClose" runat="server" resourcekey="Close" CssClass="hcTertiaryAction" NavigateUrl="vendors.aspx" />
            </div>
        </div>
	</div>
</asp:Content>
    ...
    <div class="hcColumnLeft" style="width: 50%">
        <div class="hcForm">
            <div class="hcFormItem">
                ...
                <asp:RequiredFieldValidator ID="rfvDisplayNameField" resourcekey="rfvDisplayNameField" runat="server" ControlToValidate="DisplayNameField" Display="Dynamic" CssClass="hcFormError"/>
            </div>
            <div class="hcFormItem">
                <label class="hcLabel"><%=Localization.GetString("Email") %></label>
                <asp:TextBox ID="EmailField" runat="server" MaxLength="255" TabIndex="2001" Width="100%" />
            </div>
            <div class="hcFormItem">
                <label class="hcLabel"><%=Localization.GetString("DropShipEmailTemplate") %></label>
