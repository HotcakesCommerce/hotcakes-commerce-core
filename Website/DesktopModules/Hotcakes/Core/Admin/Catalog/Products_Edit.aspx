...
<asp:Content ContentPlaceHolderID="NavContent" runat="server">
    ...
    <div class="hcBlock hcBlockNotTopPadding">
        <div class="hcForm">
            ...
            <div class="hcFormItem">
                <asp:HyperLink ID="lnkClone" resourcekey="lnkClone" runat="server" CssClass="hcTertiaryAction"/>
            </div>
            <div class="hcFormItem">
                <asp:LinkButton ID="btnDelete" resourcekey="btnDelete" runat="server" CssClass="hcTertiaryAction hcDeleteProduct" CausesValidation="false" OnClick="btnDelete_Click" />
            </div>
			<div class="hcFormItem">
...
<asp:Content ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="hcColumnLeft" style="width: 50%">
        <div class="hcForm">
            ...
            <div class="hcFormItem">
                <label class="hcLabel"><%=Localization.GetString("lblProductStyle") %></label>
                <asp:RadioButtonList ID="rbBehaviour" AutoPostBack="true" CausesValidation="false"
                    ...
                    <asp:ListItem resourcekey="rbBehaviour_Product" Value="" Selected="True" />
                    <asp:ListItem resourcekey="rbBehaviour_Bundle" Value="B" />
                    <asp:ListItem resourcekey="rbBehaviour_GiftCard" Value="GC" />
                </asp:RadioButtonList>
            </div>
            <div class="hcFormItem">
                <label class="hcLabel"><%=Localization.GetString("lblProductName") %><i class="hcLocalizable"></i></label>
                <asp:TextBox ID="txtProductName" ClientIDMode="static" runat="server" Width="50%" />
                <asp:RequiredFieldValidator ID="valNameRequired" resourcekey="valNameRequired" runat="server" Display="Dynamic"
                    ControlToValidate="txtProductName" CssClass="hcFormError" />
                <hcc:TextBoxLengthValidator runat="server" ID="tlvNameLength" MaxLength="512" ControlToValidate="txtProductName" Display="Dynamic"
                    Text='<%=Localization.GetString("tlvNameLength") %>' CssClass="hcFormError" />
            </div>
            <div class="hcFormItem hcFormItem50p">
                ...
                <asp:RequiredFieldValidator ID="valSkuRequired" resourcekey="valSkuRequired" runat="server" ControlToValidate="SkuField" Display="Dynamic" CssClass="hcFormError" />
                <hcc:TextBoxLengthValidator runat="server" ID="tlvSkuLength" MaxLength="50" ControlToValidate="SkuField" Display="Dynamic"
                    Text='<%=Localization.GetString("tlvSkuLength") %>' CssClass="hcFormError" />
            </div>
            <div class="hcFormItem hcFormItem50p hcAlignRight">
                <label class="hcLabel"><%=Localization.GetString("lblProductType") %></label>
                <asp:DropDownList ID="lstProductType" runat="server" AutoPostBack="True" CausesValidation="false" Width="95%" />
                <asp:CustomValidator ID="ProductTypeCustomValidator" runat="server" Display="Dynamic" OnServerValidate="ProductTypeCustomValidator_ServerValidate" />
            </div>
            <div>
        ...
        <asp:Panel ID="pnlPricing" runat="server" class="hcForm">
            ...
            <div class="hcFormItem">
                <asp:CheckBox CssClass="hcUserPrice" ID="chkUserPrice" resourcekey="chkUserPrice" runat="server" />
            </div>
            <div class="hcFormItem">
                <asp:CheckBox ID="chkHideQty" resourcekey="chkHideQty" runat="server" />
            </div>
            <div class="hcFormItem">
                <label class="hcLabel"><%=Localization.GetString("lblUserPriceLabel") %><i class="hcLocalizable"></i></label>
            ...
            <div class="hcFormItem hcFormItem50p">
                ...
                <asp:RequiredFieldValidator ID="rfvListPrice" resourcekey="rfvListPrice" runat="server" CssClass="hcFormError" Display="Dynamic" ControlToValidate="ListPriceField" />
                <asp:CustomValidator ID="cvListPrice" resourcekey="cvListPrice" runat="server" ControlToValidate="ListPriceField" Display="Dynamic" CssClass="hcFormError" />
            </div>
            <div class="hcFormItem hcFormItem50p">
                ...
                <asp:RequiredFieldValidator ID="rfvCostField" resourcekey="rfvCostField" runat="server" ControlToValidate="CostField" Display="Dynamic" CssClass="hcFormError" />
                <asp:CustomValidator ID="cvCostField" resourcekey="cvCostField" runat="server" ControlToValidate="CostField" Display="Dynamic" CssClass="hcFormError" />
            </div>
            <div class="hcFormItem hcFormItem50p">
                ...
                <asp:RequiredFieldValidator ID="rfvSitePrice" resourcekey="rfvSitePrice" runat="server" CssClass="hcFormError" Display="Dynamic" ControlToValidate="SitePriceField" />
                <asp:CustomValidator ID="cvSitePrice" resourcekey="cvSitePrice" runat="server" ControlToValidate="SitePriceField" Display="Dynamic" CssClass="hcFormError" />
            </div>
            <div class="hcFormItem hcFormItem50p">
                <label class="hcLabel"><%=Localization.GetString("lblText") %><i class="hcLocalizable"></i></label>
        ...
        <div class="hcForm">
            ...
            <div class="hcFormItem hcFormItem50p">
                <label class="hcLabel"><%=Localization.GetString("lblManufacturer") %></label>
    ...
    <div class="hcColumnRight hcLeftBorder" style="width: 49%">
        <div class="hcForm">
            ...
            <div class="hcFormItem hcFormItem50p">
                <asp:CheckBox Checked="true" ID="chkActive" resourcekey="chkActive" runat="server" />
            </div>
            <div class="hcFormItem hcFormItem50p">
                <asp:CheckBox Checked="true" ID="chkSearchable" resourcekey="chkSearchable" runat="server" />
            </div>
            <div class="hcFormItem hcFormItem50p">
                <asp:CheckBox ID="chkFeatured" resourcekey="chkFeatured" runat="server" />
            </div>
            <div class="hcFormItem">
            ...
            <div class="hcFormItem hcFormItem33p hcClear">
                <label class="hcLabel"><%=Localization.GetString("lblLargeImage") %></label>
                <hcc:ImageUploader runat="server" ID="ucImageUploadLarge" />
            </div>
            <div class="hcFormItem hcFormItem66p">
                <label class="hcLabel"><%=Localization.GetString("lblImageDescription") %><i class="hcLocalizable"></i></label>
                <asp:TextBox ID="MediumImageAlternateTextField" TextMode="MultiLine" Height="150px" runat="server" />
            </div>
            <div class="hcFormItem hcFormItem33p hcClear">
                <label class="hcLabel"><%=Localization.GetString("lblSmallImage") %></label>
    ...
    <div class="hcForm hcClear">
        <h2><%=Localization.GetString("DescriptionHeader") %><i class="hcLocalizable"></i></h2>
        <div class="hcFormItem">
            <hcc:HtmlEditor ID="LongDescriptionField" runat="server" EditorHeight="300" EditorWidth="1340" EditorWrap="true" />
        </div>
        <div class="hcFormItem hcFormItemLeft">
            <label class="hcLabel"><%=Localization.GetString("lblAlternateSearchKeywords") %><i class="hcLocalizable"></i></label>
            <asp:TextBox ID="txtKeywords" runat="server" />
        </div>
        <div class="hcFormItem hcFormItemRight">
            <label class="hcLabel"><%=Localization.GetString("lblMetaTitle") %><i class="hcLocalizable"></i></label>
            ...
            <hcc:TextBoxLengthValidator runat="server" ID="tlvMetaTitle" MaxLength="512" ControlToValidate="txtMetaTitle" Display="Dynamic"
                Text='<%=Localization.GetString("tlvMetaTitle") %>' CssClass="hcFormError" />
        </div>
        <div class="hcFormItem hcFormItemLeft">
        ...
        <div class="hcFormItem hcFormItemRight">
            ...
            <hcc:TextBoxLengthValidator runat="server" ID="tlvMetaDescription" MaxLength="255" ControlToValidate="txtMetaDescription" Display="Dynamic"
                Text='<%=Localization.GetString("tlvMetaDescription") %>' CssClass="hcFormError" />
        </div>
    ...
    <div class="hcForm hcClear">
        ...
        <div class="hcFormItem hcFormItemLeft">
            <label class="hcLabel"><%=Localization.GetString("lblTaxSchedule") %></label>
            <asp:DropDownList ID="lstTaxClasses" runat="server" />
        </div>
        <div class="hcFormItem hcFormItemRight">
            <label class="hcLabel">&nbsp;</label>
            <asp:CheckBox Checked="false" ID="TaxExemptField" resourcekey="TaxExemptField" Text="Tax Exempt?" runat="server" />
        </div>
    </div>
    ...
    <div class="hcColumnLeft" style="width: 50%">
        <div class="hcForm">
            <div class="hcFormItem hcFormItem33p">
                ...
                <asp:TextBox ID="txtWeight" runat="server" CssClass="RadComboBox" /><span class="hcInset"><%=Localization.GetString("WeightType") %></span>
                <asp:RequiredFieldValidator ID="rfvWeight" resourcekey="rfvWeight" runat="server" ControlToValidate="txtWeight" Display="Dynamic" CssClass="hcFormError" />
                <asp:CustomValidator ID="cstvWeight" resourcekey="cstvWeight" runat="server" ControlToValidate="txtWeight" Display="Dynamic" CssClass="hcFormError" />
				<asp:CompareValidator ID="cvWeight" resourcekey="cvWeight" ControlToValidate="txtWeight" Type="Double" Display="Dynamic" Operator="DataTypeCheck" runat="server" CssClass="hcFormError"/>
            </div>
            <div class="hcFormItem">
                <label class="hcLabel"><%=Localization.GetString("lblExtraShipFee") %></label>
                <asp:TextBox ID="ExtraShipFeeField" runat="server" />
                <asp:RequiredFieldValidator ID="rfvExtraShipFee" resourcekey="rfvExtraShipFee" runat="server" ControlToValidate="ExtraShipFeeField" Display="Dynamic" CssClass="hcFormError" />
                <asp:CustomValidator ID="cvExtraShipFee" resourcekey="cvExtraShipFee" runat="server" ControlToValidate="ExtraShipFeeField" Display="Dynamic" CssClass="hcFormError" />
            </div>
            <div class="hcFormItem">
                <asp:CheckBox ID="chkNonShipping" resourcekey="chkNonShipping" runat="server" />
            </div>
            <div class="hcFormItem">
                <label class="hcLabel"><%=Localization.GetString("lblShippingCharges") %>
                    <i class="hcIconInfo">
                        <span class="hcFormInfo" style="display: none"><%=Localization.GetString("lblShippingCharges.Help") %></span>
                    </i>
                </label>
    ...
    <div class="hcColumnRight" style="width: 49%">
        <div class="hcForm">
            <div class="hcFormItemLabel">
                <label class="hcLabel"><%=Localization.GetString("lblDimensions") %></label>
            </div>
            <div class="hcFormItem hcFormItem33p">
                <asp:TextBox ID="txtLength" runat="server" CssClass="RadComboBox" /><span class="hcInset"><%=Localization.GetString("DimensionInset_Length") %></span>
                <asp:RequiredFieldValidator ID="rfvLength" resourcekey="rfvLength" runat="server" ControlToValidate="txtLength" Display="Dynamic" CssClass="hcFormError" />
				<asp:CompareValidator ID="cvLength" resourcekey="cvLength" ControlToValidate="txtLength" Type="Double" Display="Dynamic" Operator="DataTypeCheck" runat="server" CssClass="hcFormError"/>
            </div>
            <div class="hcFormItem hcFormItem33p">
                <asp:TextBox ID="txtWidth" runat="server" CssClass="RadComboBox"/><span class="hcInset"><%=Localization.GetString("DimensionInset_Width") %></span>
                <asp:RequiredFieldValidator ID="rfvWidth" resourcekey="rfvWidth" runat="server" ControlToValidate="txtWidth" Display="Dynamic" CssClass="hcFormError" />
                <asp:CustomValidator ID="cstvWidth" resourcekey="cstvWidth" runat="server" ControlToValidate="txtWidth" Display="Dynamic" CssClass="hcFormError" />
				<asp:CompareValidator ID="cvWidth" resourcekey="cvWidth" ControlToValidate="txtWidth" Type="Double" Display="Dynamic" Operator="DataTypeCheck" runat="server" CssClass="hcFormError"/>
            </div>
            <div class="hcFormItem hcFormItem33p">
                <asp:TextBox ID="txtHeight" runat="server" CssClass="RadComboBox" /><span class="hcInset"><%=Localization.GetString("DimensionInset_Height") %></span>
                <asp:RequiredFieldValidator ID="rfvHeight" resourcekey="rfvHeight" runat="server" ControlToValidate="txtHeight" Display="Dynamic" CssClass="hcFormError" />
                <asp:CustomValidator ID="cstvHeight" resourcekey="cstvHeight" runat="server" ControlToValidate="txtHeight" Display="Dynamic" CssClass="hcFormError" />
				<asp:CompareValidator ID="cvHeight" resourcekey="cvHeight" ControlToValidate="txtHeight" Type="Double" Display="Dynamic" Operator="DataTypeCheck" runat="server" CssClass="hcFormError"/>
            </div>
            <div class="hcFormItem">
                <label class="hcLabel"><%=Localization.GetString("lblShipMode") %></label>
            ...
            <div class="hcFormItem">
                <asp:CheckBox ID="chkShipSeparately" resourcekey="chkShipSeparately" runat="server" />
            </div>
        </div>
    </div>
    ...
    <div class="hcForm">
        <div class="hcFormItem hcFormItemLeft">
            <label class="hcLabel"><%=Localization.GetString("lblMinimumQuantity") %></label>
            <asp:TextBox ID="txtMinimumQty" runat="server" Columns="5" Rows="1" TabIndex="6050" Text="0" />
            <asp:RequiredFieldValidator ID="rfvMinimumQty" resourcekey="rfvMinimumQty" runat="server" ControlToValidate="txtMinimumQty" Display="Dynamic" CssClass="hcFormError" />
            <asp:RegularExpressionValidator ID="revMinimumQty" resourcekey="revMinimumQty" runat="server" ControlToValidate="txtMinimumQty" Display="Dynamic" ValidationExpression="[0-9]{1,6}" CssClass="hcFormError" />
        </div>
        <div class="hcFormItem hcFormItemRight">
            <label class="hcLabel"><%=Localization.GetString("lblAllowReviews") %></label>
            <asp:RadioButtonList runat="server" ID="rblAllowReviews" RepeatLayout="Flow" RepeatDirection="Horizontal">
                <asp:ListItem resourcekey="AllowReviews_Inherit" Value="" Selected="True" />
        ...
        <div class="hcFormItem hcFormItemRight">
            <label class="hcLabel"><%=Localization.GetString("lblSwatchFolderName") %></label>
    ...
    <ul class="hcActions">
        <li>
            <asp:LinkButton ID="btnUpdate" resourcekey="btnUpdate" runat="server" CssClass="hcPrimaryAction" OnClick="btnUpdate_Click" />
        </li>
        <li>
            <asp:LinkButton ID="btnSave" resourcekey="btnSave" runat="server" CssClass="hcSecondaryAction" OnClick="btnSave_Click" />
        </li>
        <li>
