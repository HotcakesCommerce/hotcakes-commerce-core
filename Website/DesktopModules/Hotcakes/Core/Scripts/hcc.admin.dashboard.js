    ...
    $.fn.adminDashboard = function() {
        return this.each(function() {
            ...
            self.loadSalesChart = function(data, labels) {
                ...
                var ctx = document.getElementById("hcDashboardSalesOverTimeChart")
                    .getContext("2d"); //self.salesChart.get(0).getContext("2d");
            ...
            self.hcTopChangeByAbandomentsBlock.on("click",
                ".hcChangeOrder",
                $.proxy(self.changeAbandomentsOrder, self));
            self.hcTopChangeByPurchasesBlock.on("click", ".hcChangeOrder", $.proxy(self.changePurchasesOrder, self));

            self.hcTopChangeJointBlock.on("click",
                ".hcChangeOrder.hcByChange",
                "ByChange",
                $.proxy(self.changeJointOrder, self));
            self.hcTopChangeJointBlock.on("click",
                ".hcChangeOrder.hcByBouncesChange",
                "ByBouncesChange",
                $.proxy(self.changeJointOrder, self));
            self.hcTopChangeJointBlock.on("click",
                ".hcChangeOrder.hcByAbandomentsChange",
                "ByAbandomentsChange",
                $.proxy(self.changeJointOrder, self));
            self.hcTopChangeJointBlock.on("click",
                ".hcChangeOrder.hcByPurchasesChange",
                "ByPurchasesChange",
                $.proxy(self.changeJointOrder, self));
