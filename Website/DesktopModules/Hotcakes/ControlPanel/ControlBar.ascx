<%@ Control Language="C#" AutoEventWireup="false" Inherits="Hotcakes.Modules.ControlPanel.ControlBar"
...
<asp:Panel ID="ControlPanel" runat="server">
    <div id="ControlBar">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <div id="ControlBar_SiteSelector">
                                            <p>
                                                <%= GetString("Tool.SwitchSites.Text") %>
                                            </p>                                            
                                            <asp:PlaceHolder ID="phcontrolbar_switchsite" runat="server"></asp:PlaceHolder>
                                    ...
                                    <li>
                                        <div id="ControlBar_LanguageSelector">
                                            <p>
                                                <%= GetString("Tool.SwitchLanguages.Text") %>
                                            </p>                                            
                                            <asp:PlaceHolder ID="phcontrolBar_SwitchLanguage" runat="server"></asp:PlaceHolder>
        ...
        <div id="ControlBar_Module_AddNewModule" class="ControlModulePanel">
            ...
            <div class="ControlModuleContainer">                
                <asp:PlaceHolder ID="phCategoryList" runat="server"></asp:PlaceHolder>
        ...
        <div id="ControlBar_Module_AddExistingModule" class="ControlModulePanel">
            ...
            <div class="ControlModuleContainer">
                ...
                <asp:PlaceHolder ID="phVisibilityLst" runat="server"></asp:PlaceHolder>
                <div class="ControlBar_chckCopyModule">
                    <input type="checkbox" id="ControlBar_Module_chkCopyModule" /><label for="ControlBar_Module_chkCopyModule"><%= GetString("Tool.MakeCopy.Text") %></label>
                </div>
                <a class="controlBar_CloseAddModules"><%= GetString("Cancel.Text") %></a>
                <div class="dnnClear">
                </div>
    ...
    <% } %>
    <asp:PlaceHolder runat="server" ID="phPerformanceBar" />
    <script type="text/javascript">
        $(function () {
            var PerformanceBar = $(".hcProductPerformanceBar");
            var CategoryPerformanceBar = $(".hcCategoryPerformanceBar");
            if (typeof PerformanceBar != 'undefined' || typeof CategoryPerformanceBar != 'undefined') {
...
<script type="text/javascript">
    ...
    dnn.controlBarSettings = {
        ...
        categoryComboId: 'CategoryList',
        searchInputId: 'ControlBar_SearchModulesInput',
        visibilityComboId: 'VisibilityLst',
    ...
    function openFileUploader() {
        var instance = dnn['<%= FileUploader != null ? FileUploader.ClientID : string.Empty %>'];
