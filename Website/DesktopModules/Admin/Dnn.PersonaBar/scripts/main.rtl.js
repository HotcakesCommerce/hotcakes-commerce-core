        ...
        var util = {
            ...
            closePersonaBar: function handleClosePersonarBar(callback, keepSelection) {
                ...
                function closeCallback() {
                    ...
                    $activePanel.animate({ right: -860 }, 189, 'linear', function () {
                        $('.socialpanel').css({ right: -860 }).hide();
                        $mask.animate({
                            opacity: 0.0
                        }, 200, function () {
                ...
                if ($mask.css("display") === 'none') {
                    savePersistentCallback = function () {
                        ...
                        $mask.animate({
                            ...
                            $panel.show().delay(100).animate({ right: personaBarMenuWidth }, 189, 'linear', function () {
                                inAnimation = false;
                    ...
                    if (activePath !== path) {
                        ...
                        $activePanel.fadeOut("fast", function handleHideCurrentPanel() {
                            $panel.css({ right: personaBarMenuWidth }).fadeIn("fast", function handleShowSelectedPanel() {
