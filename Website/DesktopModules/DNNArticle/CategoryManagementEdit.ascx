<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CategoryManagementEdit.ascx.cs" Inherits="ZLDNN.Modules.DNNArticle.CategoryManagementEdit" %>
...
<table cellspacing="0" cellpadding="0" width="560" summary="Edit Links Design Table"
    ...
    <tr>
        ...
        <td style="width: 365px">
            ...
            <asp:RequiredFieldValidator ID="valTitle" runat="server" CssClass="NormalRed" ControlToValidate="txtTitle"
                ErrorMessage="You Must Enter a Title For The Link" Display="Dynamic" resourcekey="valTitle.ErrorMessage"></asp:RequiredFieldValidator>
        </td>
    </tr>
    <tr>
        <td class="SubHead" style="width: 160px">
        ...
        <td>
            ...
            <asp:Label runat="server" ID="lbCategory" CssClass="Normal"></asp:Label>
        </td>
    </tr>
    <tr>
        <td class="SubHead" style="width: 160px">
    ...
    <tr>
        ...
        <td>
            <Portal:URL ID="ctlCategoryLink" runat="server" Width="200" ShowTabs="true" ShowUrls="true"
                ShowFiles="false" ShowTrack="False" ShowLog="False" Required="false" ShowUpLoad="false"
                ShowNone="true" ShowNewWindow="False"></Portal:URL>
        </td>
    </tr>
    <tr>
        <td class="SubHead" style="width: 160px">
    ...
    <tr>
        <td class="SubHead" style="width: 160px">
            <dnn:Label ID="plViewOrder" Suffix=":" ControlName="txtViewOrder" runat="server">
            </dnn:Label>
        </td>
        <td style="width: 365px">
            ...
            <asp:RegularExpressionValidator ID="valViewOrder" runat="server" CssClass="NormalRed"
                ...
                Display="Dynamic" resourcekey="valViewOrder.ErrorMessage" ValidationExpression="^\d*$"></asp:RegularExpressionValidator>
        </td>
    </tr>
...
<p>
    <asp:LinkButton ID="cmdUpdate" runat="server" resourcekey="cmdUpdate" BorderStyle="None"
        CssClass="UpdateLabel" OnClick="cmdUpdate_Click">Update</asp:LinkButton>&nbsp;<asp:LinkButton
            ID="cmdCancel" runat="server" resourcekey="cmdCancel" BorderStyle="None" CssClass="CancelLabel"
            CausesValidation="False" OnClick="cmdCancel_Click">Cancel</asp:LinkButton>&nbsp;<asp:LinkButton
                ID="cmdDelete" runat="server" resourcekey="cmdDelete" BorderStyle="None" CssClass="DeleteLabel"
...
<asp:Panel ID="panelLanguage" runat="server">
    <asp:Label ID="lbLanguages" runat="server" resourcekey="lbLanguages" dnnFormItem></asp:Label>
                ...
                <tr>
                    <td valign="top" align="left">
                        <asp:HyperLink NavigateUrl='<%#DotNetNuke.Common.Globals.NavigateURL(TabId, "EditCategoryLanguage",
                                                 ...
                                                 "cid=" +
                                                 DataBinder.Eval(Container.DataItem, "categoryid"))%>' runat="server"
                            ID="Hyperlink1">
                            <asp:Image ID="Hyperlink1Image" runat="server" ImageUrl="~/images/edit.gif" AlternateText="Edit"
                                resourcekey="Edit" />
                        </asp:HyperLink>
                        <asp:Label ID="Label1" runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "Language")%>'
                            CssClass="Normal">
                        </asp:Label>
                    </td>
                </tr>
    ...
    <asp:LinkButton ID="cmdAddLanguage" runat="server" resourcekey="cmdAddLanguage" BorderStyle="None"
        CssClass="AddLabel" OnClick="cmdAddLanguage_Click"></asp:LinkButton>&nbsp;
</asp:Panel>
