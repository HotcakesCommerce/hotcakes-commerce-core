        ...
        if ($options && $options.length > 0) {
            ...
            $.post(hcc.getServiceUrl("products/validate"),
                ...
                function (data) {
                    ...
                    $('#hcStockDisplay').html(stockMessage);
                ...
                .complete(function () {
                    ...
                    if (stockMessage.includes("inventoryoutofstock")) {
                        $('#hcStockDisplay').removeClass("hc-stockdisplay");
                        $('#hcStockDisplay').removeClass("alert-info");
                        $('#hcStockDisplay').attr("class", "alert alert-danger");
                    }
                    else {
                        $('#hcStockDisplay').removeClass("alert");
                        $('#hcStockDisplay').removeClass("alert-danger");
                        $('#hcStockDisplay').attr("class", "alert alert-info");
                    }
                });
        }
    }
